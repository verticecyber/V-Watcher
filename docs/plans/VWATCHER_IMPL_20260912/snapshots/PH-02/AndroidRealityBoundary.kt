...
class AndroidRealityBoundary(private val context: Context) {
  ...
  // Track internally isolated subsystems
  private val isolatedSubsystems = mutableSetOf<String>()
    ...
    return when (actionName) {
      ...
      "NAVIGATE_APP_SETTINGS" -> {
        ...
        ActionResult(
          ...
          targetAction = actionName,
          status = ActionExecutionStatus.EXECUTED,
          platformReason = "Android Settings Intent prepared for target package: $targetPackage",
          evidence = mapOf(
