        ...
        Card(
          ...
          Row(
            ...
            Column {
              ...
              Text(
                text = "All telemetry collection, normalization, routing, and inference execute strictly on-device. Zero telemetry or tokens leave this hardware.",
        ...
        Card(
          ...
          Column(modifier = Modifier.padding(16.dp)) {
            ...
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
              ...
              DiagnosticMetricRow("Homeostasis Confidence", "${homeostasis?.confidenceScore ?: 98}%", highlight = true)
